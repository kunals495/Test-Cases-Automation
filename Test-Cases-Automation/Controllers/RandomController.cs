...
namespace Test_Cases_Automation.Controllers
{
    ...
    public class RandomController : ControllerBase
    {
        ...
        public RandomController(ApiTestRunnerService service)
        {
            _service = service;
        }

        public class ApiParameterDtoRandom
        {
        ...
        public class ApiInfoRandom
        {
            public string method { get; set; }
            public string route { get; set; }
            public string url { get; set; }
            public List<ApiParameterDtoRandom> parameters { get; set; } = new List<ApiParameterDtoRandom>();
        }

        // Local generated test case types replacing AI service types
        public class GeneratedTestCaseRandom
        {
        ...
        public class PerEndpointResultRandom
        {
            public string endpoint { get; set; }
            public List<GeneratedTestCaseRandom> testcases { get; set; } = new List<GeneratedTestCaseRandom>();
        }

        public class AIResponseReplacementRandom
        {
            public List<PerEndpointResultRandom> per_endpoint { get; set; } = new List<PerEndpointResultRandom>();
            public List<GeneratedTestCaseRandom> scenario_tests { get; set; } = new List<GeneratedTestCaseRandom>();
        }

        [HttpPost("generate-testcases-random")]
        public async Task<IActionResult> GenerateTestCasesRandom([FromBody] List<ApiInfoRandom> endpoints)
        {
        ...
        private AIResponseReplacementRandom GenerateAllTestCases(List<ApiInfoRandom> endpoints)
        {
            var response = new AIResponseReplacementRandom();
            foreach (var ep in endpoints)
            {
                var per = new PerEndpointResultRandom
                {
                ...
                per.testcases.Add(new GeneratedTestCaseRandom
                {
            ...
            response.scenario_tests = new List<GeneratedTestCaseRandom>();
            return response;
        }
        ...
        private object BuildPayload(List<ApiParameterDtoRandom> parameters, string scenario, string targetParam = null)
        {
        ...
        private string DeterminePayloadType(List<ApiParameterDtoRandom> parameters)
        {
        ...
        private static string MakeInputPayloadString(ApiInfoRandom ep)
        {
